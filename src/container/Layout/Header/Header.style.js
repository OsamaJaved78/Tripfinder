...
const HeaderWrapper = styled.header`
  ...
  .sticky-outer-wrapper {
    ...
    &.isHeaderSticky {
      nav {
        &.is_transparent {
          background-color: ${themeGet("color.1", "#00FFFF")};
...
export const MobileNavbar = styled.nav`
  ...
  &.default {
    border-bottom: 1px solid ${themeGet("border.3", "#00FFFF")};
    background-color: ${themeGet("color.1", "#00FFFF")};
  }
...
export const AvatarWrapper = styled.div`
  ...
  padding: 25px 35px;
  align-items: center;
  background-color: ${themeGet("color.2", "#00FFFF")};
`;
